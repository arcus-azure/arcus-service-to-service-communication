...
using Arcus.POC.Observability.Telemetry.Serilog.Sinks.ApplicationInsights.Converters;
using GuardNet;
using Serilog;
...
namespace Arcus.Custom
{
    ...
    public static class LoggerSinkConfigurationExtensions
    {
        ...
        public static LoggerConfiguration CustomAzureApplicationInsights(
            ...
            string instrumentationKey)
        {
            ...
            return CustomAzureApplicationInsights(loggerSinkConfiguration, instrumentationKey, configureOptions: null);
        }
            ...
            Action<ApplicationInsightsSinkOptions> configureOptions)
        {
            ...
            return CustomAzureApplicationInsights(loggerSinkConfiguration, instrumentationKey, LogEventLevel.Verbose, configureOptions);
        }
            ...
            LogEventLevel restrictedToMinimumLevel)
        {
            ...
            return CustomAzureApplicationInsights(loggerSinkConfiguration, instrumentationKey, restrictedToMinimumLevel, configureOptions: null);
        }
